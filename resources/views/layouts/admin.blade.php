                                    ...
                                    @if (Route::has('login'))
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('login') }}">
                                                <i class="fa-regular fa-user"></i> <span>Masuk</span>
                                            </a>
                                        </li>
                                    @endif
                                @else
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            @if (Auth::user()->role === 'admin')
                                                <li><a class="dropdown-item" href="{{ url('/promo') }}">Kelola Promo</a></li>
                                                <li><a class="dropdown-item" href="{{ url('/servis') }}">Kelola Layanan</a></li>
                                            @endif
